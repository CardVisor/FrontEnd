...
class List extends Component {
    ...
    render() {
        ...
        const { yearsOfSingle, ageOfSingle, singleValue, singleValue2, multiValue, rangeValue, rangeValue2 } =
            this.state;
            ...
            <ul>
                <li>
                    <label>
                        ...
                        <span>
                            ...
                            <i className="sub-btn" onClick={this.handleClickEditYears}>
                                Edit
                            </i>
                            <YearsPanel
                                ref={this.yearsPanel}
                                years={yearsOfSingle}
                                onChange={this.handleYearsChanged}
                            />
                        </span>
                    </label>
                    <div className="edit">
                ...
                <li>
                    ...
                    <div className="edit">
                        ...
                        >
                            <MonthBox
                                value={makeText(rangeValue2.from) + ' ~ ' + makeText(rangeValue2.to)}
                                onClick={this._handleClickRangeBox2}
                            />
                        </Picker>
                    </div>
                </li>
...
ReactDOM.render(<Main />, Dom.nodeById('page-container'));
