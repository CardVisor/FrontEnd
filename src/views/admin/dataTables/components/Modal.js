...
function Modal2(props) {
    ...
    useEffect(() => {
        ...
        axios
            .get(`${API_SERVER}/CardCluster/MccChartsAll?month=${month}&type=${card1.cardType}`)
            .then((res) => {
                setCard1DataList({
        ...
        axios
            .get(`${API_SERVER}/CardCluster/MccChartsAll?month=${month}&type=${card2.cardType}`)
            .then((res) => {
                setCard2DataList({
                    fit: res.data.의료건강피트니스,
                    play: res.data.오락,
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size="6xl" scrollBehavior={scrollBehavior}>
            <ModalOverlay />
            <ModalContent>
                {/* maxW="1200px" */}
                ...
                <ModalBody>
                    ...
                    <Box p={5} shadow="md" borderWidth="1px">
                        <Tabs isFitted variant="enclosed">
                            ...
                            <TabPanels>
                                <TabPanel>
                                    <ColumnsTable clickedCardInfo={clickedCardInfo} month={month} />
                                </TabPanel>
                                <TabPanel>
                                    <Box p={5} shadow="md" borderWidth="1px">
                                        <Text fontSize="22px" fontWeight="700" lineHeight="100%" textAlign="center">
                                            RadarChart
                                        </Text>
                                        <Grid
                                            templateColumns={{
                ...
                <ModalFooter>
                    <Button colorScheme="purple" backgroundColor={'#5E3AFF'} mr={3} onClick={onClose}>
                        Close
                    </Button>
                </ModalFooter>
            </ModalContent>
