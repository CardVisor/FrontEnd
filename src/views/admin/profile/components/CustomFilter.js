...
export default function CustomFilter() {
  ...
  const handleSelection = () => {
    ...
    axios.post('/customer/filterstats', filters)
        ...
        >
          <Flex alignItems="center">
            ...
            <CheckboxGroup spacing={2} display="flex" onChange={handleCheckboxChange(setAgeRange)}>
              <Checkbox value="2" style={{ color: 'black', marginRight: '10px', borderColor: '#5E3AFF', fontWeight: '800' }}>20대</Checkbox>
              <Checkbox value="3" style={{ color: 'black', marginRight: '10px', borderColor: '#5E3AFF', fontWeight: '800' }}>30대</Checkbox>
              <Checkbox value="4" style={{ color: 'black', marginRight: '10px', borderColor: '#5E3AFF', fontWeight: '800' }}>40대</Checkbox>
              <Checkbox value="5" style={{ color: 'black', marginRight: '10px', borderColor: '#5E3AFF', fontWeight: '800' }}>50대</Checkbox>
              <Checkbox value="6" style={{ color: 'black', marginRight: '10px', borderColor: '#5E3AFF', fontWeight: '800' }}>60대</Checkbox>
            ...
            <Button onClick={handleSelection} colorScheme="blue">조회</Button>
