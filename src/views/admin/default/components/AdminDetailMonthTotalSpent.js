...
export const TotalProvider = (props) => {
    ...
    const [lineChartDetailDataTotalSpent, setLineChartDetailDataTotalSpent] = useState([]);
    ...
    useEffect(() => {
        ...
        axios
            .all([
                axios.get(API_SERVER + '/main/detailselectLastYearPerMonthamount'),
                axios.get(API_SERVER + '/main/detailselectPerMonthamount'),
                axios.get(API_SERVER + '/main/detailperMonthTotalAmount'),
                axios.get(API_SERVER + '/main/detailtotalIncrese'),
            ])
            .then(
