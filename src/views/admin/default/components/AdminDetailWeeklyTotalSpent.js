...
export const TotalProvider = (props) => {
    ...
    const [lineChartDataWeekTotalSpent, setLineChartDataWeekTotalSpent] = useState([]);
    ...
    useEffect(() => {
        axios
            .all([
                axios.get(API_SERVER + '/main/detailselectPerWeeklyamount'),
                axios.get(API_SERVER + '/main/detailselectLastYearPerMonthamount'),
                axios.get(API_SERVER + '/main/detailweektotalIncrese'),
                axios.get(API_SERVER + '/main/detailperWeekTotalAmount'),
            ])
            .then(
