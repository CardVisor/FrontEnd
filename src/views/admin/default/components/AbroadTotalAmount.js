...
function AbroadTotalAmount(props) {
    ...
    const [abroadlastmonthtotalamount, setAbroadLastMonthTotalAmount] = useState();
    useEffect(() => {
        axios({
            method: 'get',
            url: API_SERVER + '/main/abroadTotalAmount',
        })
            .then((res) => {
    ...
    useEffect(() => {
        axios({
            method: 'get',
            url: API_SERVER + '/main/abroadLastMonthTotalAmount',
        })
            .then((res) => {
